...
static int altevcfb_probe(struct platform_device *dev)
{
  ...
  displayindex = 0;
  while ((pdispconfig[displayindex].dispid != displayid) && (pdispconfig[displayindex].dispid != NODISPLAY))
    displayindex ++;
  
  if (pdispconfig[displayindex].dispid != displayid)
  {
    displayindex = 0;
  ...
  info->var.xres = pdispconfig[displayindex].rezx;
  info->var.yres = pdispconfig[displayindex].rezy;
  info->var.xres_virtual = pdispconfig[displayindex].rezx;
  info->var.yres_virtual = pdispconfig[displayindex].rezy;
  
  info->var.pixclock = pdispconfig[displayindex].pclk_freq;
  
  info->var.left_margin = pdispconfig[displayindex].hs_fp;
  info->var.right_margin = pdispconfig[displayindex].hs_bp;
  info->var.hsync_len = pdispconfig[displayindex].hs_w;
  info->var.upper_margin = pdispconfig[displayindex].vs_fp;
  info->var.lower_margin = pdispconfig[displayindex].vs_bp;
  info->var.vsync_len = pdispconfig[displayindex].vs_w;
