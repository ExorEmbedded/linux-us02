...
static int stmmac_plat_init(struct platform_device *pdev, void* private);
...
static const struct of_dev_auxdata socfpga_auxdata_lookup[] __initconst = {
	...
	OF_DEV_AUXDATA("arm,pl330", 0xffe00000, "dma-pl330", &dma_platform_data),
	OF_DEV_AUXDATA("arm,pl330", 0xffe01000, "dma-pl330", &dma_platform_data),
#ifdef CONFIG_HW_PERF_EVENTS
